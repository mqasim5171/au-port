...
function Suggestions() {
  ...
  useEffect(() => {
    if (selectedCourse) {
      api
        .get(`/courses/${selectedCourse}/quality-score`)
        .then((res) => setQualityScore(res.data))
    ...
    <div className="fade-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          AI-powered suggestions to enhance course content and delivery
        </p>
      </div>
            ...
            >
              ...
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  {/* Breakdown */}
                  {["completeness_score", "alignment_score", "feedback_score"].map(
                    (metric, idx) => (
                        ...
                        <div className="progress-bar">
                          <div
                            ...
                            style={{
                              ...
                              background:
                                qualityScore[metric] >= 80
                                  ? "#10b981"
                                  : qualityScore[metric] >= 60
                                  ? "#f59e0b"
                                  : "#ef4444",
                            }}
                          ></div>
              ...
              <div className="card">
                ...
                <div className="card-content">
                  {Array.isArray(qualityScore.suggestions) &&
                  ...
                  >
                    ...
                    <div style={{ fontSize: "14px", color: "#dc2626" }}>
                      Address negative feedback patterns to improve student
